...
using NEXOSAPI.Infrastructure.Mapping;
using NEXOSAPI.Persistence;
using NEXOSAPI.Service.Contract;
using NEXOSAPI.Service.Implementation;
using System;
...
namespace NEXOSAPI.Infrastructure.Extension
{
    public static class ConfigureServiceContainer
    {
             ...
             IConfiguration configuration, IConfigurationRoot configRoot)
        {
            ...
            //       options.UseSqlServer(configuration.GetConnectionString("NexosApp") ?? configRoot["ConnectionStrings:NexosApp"]
            //    , b => b.MigrationsAssembly(typeof(ApplicationDbContext).Assembly.FullName)));

            serviceCollection.AddDbContext<ApplicationDbContext>(options =>
            options.UseOracle(configuration.GetConnectionString("NexosApp") ?? configRoot["ConnectionStrings:NexosApp"]
            , b => b.MigrationsAssembly(typeof(ApplicationDbContext).Assembly.FullName)));
            ...
            serviceCollection.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    ...
                    new OpenApiInfo()
                    {
                        Title = "NEXOS WebAPI",
                        Version = "1",
                        Description = "Through this API you can access NEXOS App",
                        Contact = new OpenApiContact()
                        {
                            Email = "contact@nexos.com",
                            Name = "Contact",
                            Url = new Uri("https://nexos.github.io/")
                        },
